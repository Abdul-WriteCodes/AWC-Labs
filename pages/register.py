...
<div class="lab-icon-strip">
  <div class="lab-icon-pill">
    <svg width="12" height="15" viewBox="0 0 12 15" fill="none" xmlns="http://www.w3.org/2000/svg">
      <line x1="4" y1="0" x2="4" y2="6" stroke="#00B4D8" stroke-width="1.2" stroke-linecap="round"/>
      <line x1="8" y1="0" x2="8" y2="6" stroke="#00B4D8" stroke-width="1.2" stroke-linecap="round"/>
      <line x1="2" y1="0" x2="10" y2="0" stroke="#00B4D8" stroke-width="1.2" stroke-linecap="round"/>
      <polygon points="4,6 1,13 11,13 8,6" fill="none" stroke="#00B4D8" stroke-width="1" stroke-linejoin="round"/>
      <ellipse cx="6" cy="13" rx="5" ry="1.5" fill="none" stroke="#00B4D8" stroke-width="0.7" opacity="0.5"/>
    </svg>
    Flask lab
  </div>
  <div class="lab-icon-pill">
